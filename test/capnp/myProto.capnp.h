...
CAPNP_DECLARE_SCHEMA(90ee36046443a5fb);
CAPNP_DECLARE_SCHEMA(c3bcfa9e3d669e4d);
...
struct Person {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(ed5bcc458b243f52, 1, 4)
    #if !CAPNP_LITE
...
struct Person::Employment {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(90ee36046443a5fb, 1, 4)
    #if !CAPNP_LITE
    static constexpr ::capnp::_::RawBrandedSchema const* brand() { return &schema->defaultBrand; }
    #endif  // !CAPNP_LITE
  };
...
struct AddressBook {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(c3bcfa9e3d669e4d, 0, 1)
    #if !CAPNP_LITE
    static constexpr ::capnp::_::RawBrandedSchema const* brand() { return &schema->defaultBrand; }
    #endif  // !CAPNP_LITE
  };
